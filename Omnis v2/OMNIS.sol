...
\ \ \/\ \   /\      \   \ \ `\\ \   \/_/\ \/    \ \,\L\_\            \ \ \L\ \  \/_/\ \/    \/_/\ \/
 \ \ \ \ \  \ \ \__\ \   \ \ , ` \     \ \ \     \/_\__ \    _______  \ \  _ <'    \ \ \       \ \ \
  \ \ \_\ \  \ \ \_/\ \   \ \ \`\ \     \_\ \__    /\ \L\ \ /\______\  \ \ \L\ \    \_\ \__     \ \ \
    ...
    *If you find any bug or need to ask any question please contact us*
    ...
    Notes:
    1) Bug fixes applied according to audit results, https://gist.github.com/yuriy77k/d428ef1b66cf2857787bf6110216d1c8,
    however, for element 3.9, several test and simulations should be made to determine a safe max array size,
    currently there is no fix applied for it.

    2) No mitigation applied on contract for approve/transferFrom ERC20 issue https://github.com/ethereum/EIPs/issues/738

    ---Fixes Applied by Fares A. Akel C.

    3) Fixed fee set to 0.2%

    Contract Developed and Designed by StartBlock for the OMNIS Team
